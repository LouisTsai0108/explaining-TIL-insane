/* 1. PHÂN TÍCH SẢN PHẨM (SALES VOLUME BY PRODUCT, SALES VOLUME BY PRODUCT CATEGORY, SALES REVENUE BY PRODUCT, SALES REVENUE BY PRODUCT CATEGORY)*/
SELECT *          
...
--- 6. CÓ BAO NHIÊU GIAO DỊCH THÀNH CÔNG TRONG 4 NĂM
...
/* 2. PHÂN TÍCH DOANH THU THEO VÙNG (SALES REVENUE BY REGION, MARGIN PER DATE BY COUNTRY, MARGIN BY COUNTRY) */
SELECT     E.NAME,
           F.NAME,
           COUNT(DISTINCT E.NAME) AS NUMOFPRODUCTSCATEGORY,        
